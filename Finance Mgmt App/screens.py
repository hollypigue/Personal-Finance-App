from common import Screen, FloatLayout, Label, TextInput, DropDown, Button, ScrollView, GridLayout, Popup, BoxLayout, CheckBox, ToggleButton, App
...
class HomeScreen(Screen):
    def __init__(self, **kwargs):
        ...
        app_name = Label(
            text="Finance Manager", font_name='C:/Windows/Fonts/georgia.ttf' , font_size='25sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(300, 50), pos_hint={'center_x': 0.5, 'center_y': 0.7}
        )
...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        screen_name = Label(
            text="Login", font_name='C:/Windows/Fonts/georgia.ttf', font_size='25sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(300, 50), pos_hint={'center_x': 0.5, 'center_y': 0.7}
        )
        
        layout.add_widget(screen_name)
...
class FinanceScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Transactions label
        label = Label(text="Transactions", font_name='C:/Windows/Fonts/georgia.ttf', font_size='20sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(300, 50), pos_hint={'center_x': 0.5, 'center_y': 0.85})
...
class AccountSummaryScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Title Label
        title_label = Label(text="Account Summary", font_name='C:/Windows/Fonts/georgia.ttf', font_size='20sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(300, 50), pos_hint={'center_x': 0.5, 'center_y': 0.9})
...
class SettingsScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Label for the settings screen title
        label = Label(text="Settings", font_name='C:/Windows/Fonts/georgia.ttf', font_size='24sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(200, 50), pos_hint={'center_x': 0.5, 'center_y': 0.85})
...
class ChangePassword(Screen):
    def __init__(self, **kwargs):
        ...
        label = Label(text="Change Password Page", font_name='C:/Windows/Fonts/georgia.ttf', size_hint=(0.2, 0.1), color=(0,0,0,1), pos_hint={'center_x': 0.5, 'top': 0.9})
        layout.add_widget(label)
...
class NotificationPreferences(Screen):
    def __init__(self, **kwargs):
        ...
        label = Label(text="Notification Preferences Page", font_name='C:/Windows/Fonts/georgia.ttf', size_hint=(0.2, 0.1), color=(0,0,0,1), pos_hint={'center_x': 0.5, 'top': 0.9})
        layout.add_widget(label)
...
class PrivacySettings(Screen):
    def __init__(self, **kwargs):
        ...
        label = Label(text="Privacy Settings Page", font_name='C:/Windows/Fonts/georgia.ttf', size_hint=(0.2, 0.1), color=(0,0,0,1), pos_hint={'center_x': 0.5, 'top': 0.9})
        layout.add_widget(label)
...
class AccountManagement(Screen):
    def __init__(self, **kwargs):
        ...
        label = Label(text="Account Management Page", font_name='C:/Windows/Fonts/georgia.ttf', size_hint=(0.2, 0.1), color=(0,0,0,1), pos_hint={'center_x': 0.5, 'top': 0.9})
        layout.add_widget(label)

        # Update Email
        email_label = Label(text="Email of Account:", size_hint=(0.2, 0.1), color=(0,0,0,1), pos_hint={'x': 0.1, 'top': 0.75})
...
class About(Screen):
    def __init__(self, **kwargs):
        ...
        label = Label(text="About Page", font_name='C:/Windows/Fonts/georgia.ttf', size_hint=(0.2, 0.1), color=(0,0,0,1), pos_hint={'center_x': 0.5, 'top': 0.9})
        layout.add_widget(label)
