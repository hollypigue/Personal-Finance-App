...
class CreateAccountScreen1(Screen):
    def __init__(self, **kwargs):
        ...
        with layout.canvas.before:
            ...
            Color(0.8, 1, 0.8, 1)  # RGBA values for a soft green color
            self.rect = Rectangle(size=Window.size)
...
class CreateAccountScreen2(Screen):
    def __init__(self, **kwargs):
        ...
        # Confirm Password
        confirm_password = Label(text="Confirm Password", font_size='14sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(150, 30), pos_hint={'center_x': 0.2, 'center_y': 0.4})
        ...
        # Create Account Button
        btn_create_account = RoundedButton(text="Create Account", pos_hint={'center_x': 0.5, 'center_y': 0.2})
...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        lbl_username = Label(text="Username", font_size='14sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(100, 30), pos_hint={'center_x': 0.5, 'center_y': 0.6})
        ...
        lbl_password = Label(text="Password", font_size='14sp', color=(0, 0, 0, 1), size_hint=(None, None), size=(100, 30), pos_hint={'center_x': 0.5, 'center_y': 0.4})
        ...
        # Login Button
        btn_login = RoundedButton(text="Login", pos_hint={'center_x': 0.5, 'center_y': 0.2})
        btn_login.bind(on_press=self.login)
        layout.add_widget(btn_login)

        # Cancel Button
        btn_cancel = RoundedButton(text="Cancel", pos_hint={'center_x': 0.5, 'center_y': 0.1})
